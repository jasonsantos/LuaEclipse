...
public class LuaLongStringSyntaxRule implements IPredicateRule {

	public IToken evaluate(ICharacterScanner scanner, boolean resume) {
		int c = scanner.read();
		if ((char) (c) == '[') {
			return longString(scanner, ILuaPartitions.LUA_STRING);
		}
		scanner.unread();
	...
	public IToken getSuccessToken() {
		return new Token(ILuaPartitions.LUA_STRING);
	}

	...
	private void makeActions() {
		action1 = new Action() {
			public void run() {
				...
				analyser.refreshSummary("/home/guilherme/lua/luaprofiler-2.0/src/analyzer/teste1.out");
				viewer.refresh();
				showMessage("Profiler information updated");				
			}
		};
		action1.setText("Refresh Profile Information");
		action1.setToolTipText("Refresh Profile Information");
		action1.setImageDescriptor(Activator.getImageDescriptor("icons/refresh-icon.gif"));
